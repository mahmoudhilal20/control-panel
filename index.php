<?php
	...
	if(isset($_SESSION["UserType"])){
		 if ($_SESSION["UserType"]=="Admin"){
			header("refresh:0,url=admin/domains.php"); 
		}
		else if ($_SESSION["UserType"]=="Member"){
		  header("refresh:0,url=member/domains.php"); 
	  }
	}
	if(isset($_GET['error'])) {
		$error = $_GET['error'];
				...
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(assets/media/bg/bg-2.jpg);">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form" action="login.php" method="POST">
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" placeholder="UserName or ID" name="UserName" autocomplete="off" required/>
								</div>
								<div class="form-group">
