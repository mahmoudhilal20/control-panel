...
if(isset($_POST['EditUrl'])){
	require_once '../include/db_manage.php';
		...
		$Link = $_POST['UrlLink'];
		$db1 = new DB_manage();
		$db1->Update_BackUrl($ID,$Name,$Link);
		if ($db1==false){
			echo'<script>
			alert("wrong");</script>';
						}
...
if (isset($_GET['Removeurl']))
{$Removeurl=$_GET['Removeurl'];
	require_once '../include/db_manage.php';
	$db = new DB_manage();
	$db->Remove_BackUrl($Removeurl);
	if ($db!==true){
		echo'<script>
		alert("This Url Can not be deleted. It is used in landing pages");</script>';
					}
	}
...
<head>
	...
	<meta charset="utf-8" />
	<title>| BACK URls</title>
	<meta name="description" content="Back Urls" />
						...
						<div class="card card-custom">
							<div class="card-header flex-wrap border-0 pt-6 pb-0">
								<div class="card-title">
									<h3 class="card-label">Back Urls Table</h3>
								</div>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form class="form" action="backurls.php"  method="POST">
														<div class="card-body">
															<div class="form-group">
																<label>URL Name:</label>
																<input type="text" name="Name"
																	class="form-control form-control-solid"
																	placeholder="enter your URL Name" required/>
															...
															<div class="form-group">
																...
																<input type="text" name="Link"
																	class="form-control form-control-solid"
																	placeholder="enter your Url Link" required/>
																<span class="form-text text-muted">Please enter your URL
																	link</span>
															</div>
														</div>
														<div class="card-footer">
															<button type="submit" name="AddUrl"
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form class="form" action="backurls.php"  method="POST">
												<div class="card-body">
													<div class="form-group">
													<input id="UrlID" type="hidden" name="UrlID" />
														<label>URL Name:</label>
													...
													<div class="form-group">
														<label>URL Link</label>
														<input id="UrlLink" type="text" name="UrlLink"  
															class="form-control form-control-solid"
												...
												<div class="card-footer">
													<button type="submit" name="EditUrl"
														class="btn btn-primary mr-2">Submit</button>
												</div>
											</form>
										</div>
...
{header("refresh:0,url=../index.php");
	...
	<script src="./.././assets/js/backurlstable.js"></script>
	<!--end::Page Scripts-->
</body>
<!--end::Body-->
