...
if (isset($_GET['RemoveLP']))
{$RemoveLP=$_GET['RemoveLP'];
	$DomainID=$_GET['DomainID'];
	require_once '../include/db_manage.php';
	$db = new DB_manage();
	$db->Remove_LandingPage($RemoveLP);
	if ($db==true){
		echo'<script>
...
$db = new DB_Display();
$db->LandingPage_Display($DomainID);
	}
?>
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Landing Pages Table
											</div>
										<div class="card-toolbar">
											...
											<!--end::Dropdown-->
											<!--begin::Button-->
											<a href="createlandingpage.php?DomainID=<?php echo $DomainID ?>" class="btn btn-primary font-weight-bolder">
